...
def visualize_motion(mjcf_path, mot_path, playback_speed=1.0):
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        ...
        while viewer.is_running():
            ...
            # Process user input for pause/reset here if desired (not shown)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Visualize MuJoCo model with .mot motion data using PD control')
